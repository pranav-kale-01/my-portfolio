...
const ScrollContainer = ({ text, children }) => {
  useEffect(() => {
  ...
  return (
    <div className="horizontal-scroll-container h-[100vh]">
      <div className="horizontal-scroll-element overflow-hidden sticky top-0 h-screen ">
        <h1 className="text-6xl text-bold w-full text-center text-white mt-36 mb-20">
          {text}
        </h1>
        <div className="horizontal-scroll-section will-change-transform flex justify-between items-center ">
          <div className="horizontal-scroll-item flex flex-shrink-0 h-screen">
            {children}
          </div>
        </div>
      </div>
